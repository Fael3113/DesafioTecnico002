...
public class ProcessoTabelaDAO {
	...
	private static final String SQL_SELECT_BY_PROCESSO_HABILITADO =
			"SELECT * FROM TB_REPLICACAO_PROCESSO_TABELA WHERE PROCESSO = ? AND HABILITADO = TRUE ORDER BY ORDEM";
	...
	private static final String SQL_INSERT =
			"INSERT INTO TB_REPLICACAO_PROCESSO_TABELA (PROCESSO_ID, TABELA_ORIGEM, TABELA_DESTINO, ORDEM, HABILITADO, DS_WHERE) " +
					"VALUES (?, ?, ?, ?, ?, ?)";
	...
	public ArrayList<TB_REPLICACAO_PROCESSO_TABELA> selectByProcessoHabilitado(long processo_id) throws SQLException {
